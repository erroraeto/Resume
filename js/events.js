import*as THREE from"three";let gl=document.querySelector("#gl"),textures=(gl.height=gl.clientHeight,gl.width=gl.clientWidth,["../img/1.png","../img/2.png","../img/3.png","../img/4.png","../img/5.png","../img/6.png","../img/7.png","../img/8.png"].map(e=>(new THREE.TextureLoader).load(e))),camera=new THREE.PerspectiveCamera(70,window.innerWidth/window.innerHeight,.01,10),scene=(camera.position.z=1.4,new THREE.Scene),geometry=new THREE.PlaneGeometry(1.5,1,10,10),material=new THREE.ShaderMaterial({uniforms:{uTexture:{value:textures[0]},positionVlak3:{value:-3.5},transparent:!0},vertexShader:`
        varying vec2 vUv;
        void main(){
        vUv = uv;
